  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
      <div className="space-y-4 md:space-y-6 mb-8 pb-8 border-b border-slate-100">
        <h3 className="text-[10px] font-black text-accent uppercase tracking-[0.2em] mb-4">Parent Account Info</h3>
        <OnboardingInput icon={<User size={18} />} label="Parent Full Name" placeholder="John Doe" />
